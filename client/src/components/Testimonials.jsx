      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Quote className="absolute top-6 right-6 text-primary/10 w-16 h-16 transform group-hover:scale-110 transition-transform duration-300" />
              ...
              <div className="flex items-center gap-4 border-t border-border/50 pt-6 mt-auto">
                ...
                />
                <div>
                  <h4 className="font-bold font-heading text-text">{testimonial.name}</h4>
